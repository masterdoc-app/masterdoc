...
flowchart TB
  ...
  Plan --> Calendar
  Calendar -->|плановая работа| Request
  Technologist -->|draft-регламент из ИЭ| Plan
  Doc --> Technologist
