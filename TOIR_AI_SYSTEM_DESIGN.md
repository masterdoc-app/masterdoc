...
> Скоуп: проектируем **работающую систему** — учёт, заявки, журналы, регламенты, роли и ИИ в ежедневных операциях. Склад ЗИП, кладовщик, подрядчики и голосовой ввод/STT сознательно вынесены за рамки первых релизов — в backlog.
...
| **Backlog** | Склад ЗИП и кладовщик; заявки на запчасти; голосовой ввод и STT; внешний инженер/contractor не в штате | Возвращаем по сигналам custdev |
