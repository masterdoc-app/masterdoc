...
**Принцип MVP:** сначала **журнал + заявка + привязка к оборудованию + документы + отчёты**. Склад ЗИП, кладовщик, подрядчики, голос/STT, Excel-импорт и массовый онбординг — **backlog**, не первые релизы.
...
- Голосовой ввод / STT  
- Массовый AI-онбординг, пакетные фото шильдиков, импорт Excel  
...
- Голосовой ввод / STT  
- Excel-импорт и массовый AI-онбординг  
...
| **Backlog** | — | Склад ЗИП, кладовщик, contractor, голос/STT, Excel-импорт |
...
| Scope creep (ЗИП, contractor, голос, Excel-импорт) | Жёсткий backlog; не включать в первые релизы |
