...
**Принцип MVP:** сначала **журнал + заявка + привязка к оборудованию + документы + отчёты**. Склад ЗИП, кладовщик, подрядчики и голос/STT — **backlog**, не первые релизы.
...
| **Backlog** | — | Склад ЗИП, кладовщик, contractor, голос/STT |
...
| Scope creep (ЗИП, contractor, голос) | Жёсткий backlog; не включать в первые релизы |
